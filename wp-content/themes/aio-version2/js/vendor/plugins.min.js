...
(function($){var $background=$("<img />").addClass("vegas-background"),$overlay=$("<div />").addClass("vegas-overlay"),$loading=$("<div />").addClass("vegas-loading"),$current=$(),paused=null,backgrounds=[],step=0,delay=5E3,walk=function(){},timer,methods={init:function(settings){var options={src:getBackground(),align:"center",valign:"top",fade:1E3,loading:true,load:function(){},complete:function(){}};$.extend(options,$.vegas.defaults.background,settings);if(options.loading)loading();var $new=$background.clone();
$new.css({"position":"absolute","left":"0px","top":"0px"}).bind("load",function(){if($new==$current)return;$(window).bind("load resize.vegas",function(e){resize($new,options)});if($current.is("img")){$current.stop();$new.hide().insertAfter($current).fadeIn(options.fade,function(){$(".vegas-background").not(this).remove();$("body").trigger("vegascomplete",[this,step-1]);options.complete.apply($new,[step-1])})}else $new.hide().prependTo("#rotate").fadeIn(options.fade,function(){$("#rotate").trigger("vegascomplete",
[this,step-1]);options.complete.apply(this,[step-1])});$current=$new;resize($current,options);if(options.loading)loaded();$("#rotate").trigger("vegasload",[$current.get(0),step-1]);options.load.apply($current.get(0),[step-1]);if(step){$("#rotate").trigger("vegaswalk",[$current.get(0),step-1]);options.walk.apply($current.get(0),[step-1])}}).attr("src",options.src);return $.vegas},destroy:function(what){if(!what||what=="background"){$(".vegas-background, .vegas-loading").remove();$(window).unbind("resize.vegas");
$current=$()}if(what=="overlay")$(".vegas-overlay").remove();return $.vegas},overlay:function(settings){var options={src:null,opacity:null};$.extend(options,$.vegas.defaults.overlay,settings);$overlay.remove();$overlay.css({"margin":"0","padding":"0","position":"fixed","left":"0px","top":"0px","width":"100%","height":"100%"});if(options.src)$overlay.css("backgroundImage","url("+options.src+")");if(options.opacity)$overlay.css("opacity",options.opacity);$overlay.prependTo("#rotate");return $.vegas},
slideshow:function(settings,keepPause){var options={step:step,delay:delay,preload:false,backgrounds:backgrounds,walk:walk};$.extend(options,$.vegas.defaults.slideshow,settings);if(options.backgrounds!=backgrounds){if(!settings.step)options.step=0;if(!settings.walk)options.walk=function(){};if(options.preload)$.vegas("preload",options.backgrounds)}backgrounds=options.backgrounds;delay=options.delay;step=options.step;walk=options.walk;clearInterval(timer);if(!backgrounds.length)return $.vegas;var doSlideshow=
function(){if(step<0)step=backgrounds.length-1;if(step>=backgrounds.length||!backgrounds[step-1])step=0;var settings=backgrounds[step++];settings.walk=options.walk;if(typeof settings.fade=="undefined")settings.fade=options.fade;if(settings.fade>options.delay)settings.fade=options.delay;$.vegas(settings)};doSlideshow();if(!keepPause){paused=false;$("#rotate").trigger("vegasstart",[$current.get(0),step-1])}if(!paused)timer=setInterval(doSlideshow,options.delay);return $.vegas},next:function(){var from=
step;if(step){$.vegas("slideshow",{step:step},true);$("body").trigger("vegasnext",[$current.get(0),step-1,from-1])}return $.vegas},previous:function(){var from=step;if(step){$.vegas("slideshow",{step:step-2},true);$("body").trigger("vegasprevious",[$current.get(0),step-1,from-1])}return $.vegas},jump:function(s){var from=step;if(step){$.vegas("slideshow",{step:s},true);$("#rotate").trigger("vegasjump",[$current.get(0),step-1,from-1])}return $.vegas},stop:function(){var from=step;step=0;paused=null;
clearInterval(timer);$("#rotate").trigger("vegasstop",[$current.get(0),from-1]);return $.vegas},pause:function(){paused=true;clearInterval(timer);$("#rotate").trigger("vegaspause",[$current.get(0),step-1]);return $.vegas},get:function(what){if(what==null||what=="background")return $current.get(0);if(what=="overlay")return $overlay.get(0);if(what=="step")return step-1;if(what=="paused")return paused},preload:function(backgrounds){var cache=[];for(var i in backgrounds)if(backgrounds[i].src){var cacheImage=
document.createElement("img");cacheImage.src=backgrounds[i].src;cache.push(cacheImage)}return $.vegas}};function resize($img,settings){var options={align:"center",valign:"center"};$.extend(options,settings);if($img.height()==0){console.log("pecouille");$img.load(function(){resize($(this),settings)});return}var ww=$(window).width(),wh=$(window).height(),iw=$img.width(),ih=$img.height(),rw=wh/ww,ri=ih/iw,newWidth,newHeight,newLeft,newTop,properties;if(rw>ri){newWidth=wh/ri;newHeight=wh}else{newWidth=
ww;newHeight=ww*ri}properties={"width":newWidth+"px","height":newHeight+"px","top":"auto","bottom":"auto","left":"auto","right":"auto"};if(!isNaN(parseInt(options.valign)))properties["top"]=0-(newHeight-wh)/100*parseInt(options.valign)+"px";else if(options.valign=="top")properties["top"]=0;else if(options.valign=="bottom")properties["bottom"]=0;else properties["top"]=(wh-newHeight)/2;if(!isNaN(parseInt(options.align)))properties["left"]=0-(newWidth-ww)/100*parseInt(options.align)+"px";else if(options.align==
"left")properties["left"]=0;else if(options.align=="right")properties["right"]=0;else properties["left"]=(ww-newWidth)/2;$img.css(properties)}function loading(){$loading.prependTo("#rotate").fadeIn()}function loaded(){$loading.fadeOut("fast",function(){$(this).remove()})}function getBackground(){if($("#rotate").css("backgroundImage"))return $("#rotate").css("backgroundImage").replace(/url\("?(.*?)"?\)/i,"$1")}$.vegas=function(method){if(methods[method])return methods[method].apply(this,Array.prototype.slice.call(arguments,
1));else if(typeof method==="object"||!method)return methods.init.apply(this,arguments);else $.error("Method "+method+" does not exist")};$.vegas.defaults={background:{},slideshow:{},overlay:{}}})(jQuery);
...
(function($,self){if(!$||!self)return;for(var i=0;i<self.properties.length;i++){var property=self.properties[i],camelCased=StyleFix.camelCase(property),PrefixCamelCased=self.prefixProperty(property,true);$.cssProps[camelCased]=PrefixCamelCased}})(window.jQuery,window.PrefixFree);
(function($){var F=$.fancybox;F.helpers.buttons={tpl:'<div id="fancybox-buttons"><ul><li><a class="btnPrev" title="Previous" href="javascript:$.fancybox.prev();">Previous</a></li><li><a class="btnPlay" title="Slideshow" href="javascript:$.fancybox.play();;">Play</a></li><li><a class="btnNext" title="Next" href="javascript:$.fancybox.next();">Next</a></li><li><a class="btnToggle" title="Toggle size" href="javascript:$.fancybox.toggle();">Toggle</a></li><li><a class="btnClose" title="Close" href="javascript:$.fancybox.close();">Close</a></li></ul></div>',list:null,
buttons:{},update:function(){var toggle=this.buttons.toggle.removeClass("btnDisabled btnToggleOn");if(F.current.canShrink)toggle.addClass("btnToggleOn");else if(!F.current.canExpand)toggle.addClass("btnDisabled")},beforeShow:function(){F.current.margin[0]+=30},onPlayStart:function(){if(this.list)this.buttons.play.text("Pause").addClass("btnPlayOn")},onPlayEnd:function(){if(this.list)this.buttons.play.text("Play").removeClass("btnPlayOn")},afterShow:function(opts){var buttons;if(!this.list){this.list=
$(opts.tpl||this.tpl).appendTo("body");this.buttons={prev:this.list.find(".btnPrev"),next:this.list.find(".btnNext"),play:this.list.find(".btnPlay"),toggle:this.list.find(".btnToggle")}}buttons=this.buttons;if(F.current.index>0||F.current.loop)buttons.prev.removeClass("btnDisabled");else buttons.prev.addClass("btnDisabled");if(F.current.loop||F.current.index<F.group.length-1){buttons.next.removeClass("btnDisabled");buttons.play.removeClass("btnDisabled")}else{buttons.next.addClass("btnDisabled");
buttons.play.addClass("btnDisabled")}this.update()},onUpdate:function(){this.update()},beforeClose:function(){if(this.list)this.list.remove();this.list=null;this.buttons={}}}})(jQuery);
(function($){var F=$.fancybox;F.helpers.thumbs={wrap:null,list:null,width:0,source:function(el){var img=$(el).find("img");return img.length?img.attr("src"):el.href},init:function(opts){var that=this,list,thumbWidth=opts.width||50,thumbHeight=opts.height||50,thumbSource=opts.source||this.source;list="";for(var n=0;n<F.group.length;n++)list+='<li><a style="width:'+thumbWidth+"px;height:"+thumbHeight+'px;" href="javascript:$.fancybox.jumpto('+n+');"></a></li>';this.wrap=$('<div id="fancybox-thumbs"></div>').appendTo("body");
this.list=$("<ul>"+list+"</ul>").appendTo(this.wrap);$.each(F.group,function(i){$("<img />").load(function(){var width=this.width,height=this.height,widthRatio,heightRatio,parent;if(!that.list||!width||!height)return;widthRatio=width/thumbWidth;heightRatio=height/thumbHeight;parent=that.list.children().eq(i).find("a");if(widthRatio>=1&&heightRatio>=1)if(widthRatio>heightRatio){width=Math.floor(width/heightRatio);height=thumbHeight}else{width=thumbWidth;height=Math.floor(height/widthRatio)}$(this).css({width:width,
height:height,top:Math.floor(thumbHeight/2-height/2),left:Math.floor(thumbWidth/2-width/2)});parent.width(thumbWidth).height(thumbHeight);$(this).hide().appendTo(parent).fadeIn(300)}).attr("src",thumbSource(this))});this.width=this.list.children().eq(0).outerWidth();this.list.width(this.width*(F.group.length+1)).css("left",Math.floor($(window).width()*0.5-(F.current.index*this.width+this.width*0.5)))},update:function(opts){if(this.list)this.list.stop(true).animate({"left":Math.floor($(window).width()*
0.5-(F.current.index*this.width+this.width*0.5))},150)},beforeLoad:function(opts){if(F.group.length<2){F.coming.helpers.thumbs=false;return}F.coming.margin[2]=opts.height+30},afterShow:function(opts){if(this.list)this.update(opts);else this.init(opts);this.list.children().removeClass("active").eq(F.current.index).addClass("active")},onUpdate:function(){this.update()},beforeClose:function(){if(this.wrap)this.wrap.remove();this.wrap=null;this.list=null;this.width=0}}})(jQuery);
...
(function($){(function(a){function m(){d.setAttribute("content",g),h=!0}function n(){d.setAttribute("content",f),h=!1}function o(b){l=b.accelerationIncludingGravity,i=Math.abs(l.x),j=Math.abs(l.y),k=Math.abs(l.z),(!a.orientation||a.orientation===180)&&(i>7||(k>6&&j<8||k<8&&j>6)&&i>5)?h&&n():h||m()}var b=navigator.userAgent;if(!(/iPhone|iPad|iPod/.test(navigator.platform)&&/OS [1-5]_[0-9_]* like Mac OS X/i.test(b)&&b.indexOf("AppleWebKit")>-1))return;var c=a.document;if(!c.querySelector)return;var d=
c.querySelector("meta[name=viewport]"),e=d&&d.getAttribute("content"),f=e+",maximum-scale=1",g=e+",maximum-scale=10",h=!0,i,j,k,l;if(!d)return;a.addEventListener("orientationchange",m,!1),a.addEventListener("devicemotion",o,!1)})(this);(function($,wp,wps,window,undefined){"$:nomunge";var $w=$(window),eventName="waypoint.reached",triggerWaypoint=function(way,dir){way.element.trigger(eventName,dir);if(way.options.triggerOnce)way.element[wp]("destroy")},waypointIndex=function(el,context){if(!context)return-1;
var i=context.waypoints.length-1;while(i>=0&&context.waypoints[i].element[0]!==el[0])i-=1;return i},contexts=[],Context=function(context){$.extend(this,{element:$(context),oldScroll:0,"waypoints":[],didScroll:false,didResize:false,doScroll:$.proxy(function(){var newScroll=this.element.scrollTop(),isDown=newScroll>this.oldScroll,that=this,pointsHit=$.grep(this.waypoints,function(el,i){return isDown?el.offset>that.oldScroll&&el.offset<=newScroll:el.offset<=that.oldScroll&&el.offset>newScroll}),len=
pointsHit.length;if(!this.oldScroll||!newScroll)$[wps]("refresh");this.oldScroll=newScroll;if(!len)return;if(!isDown)pointsHit.reverse();$.each(pointsHit,function(i,point){if(point.options.continuous||i===len-1)triggerWaypoint(point,[isDown?"down":"up"])})},this)});$(context).bind("scroll.waypoints",$.proxy(function(){if(!this.didScroll){this.didScroll=true;window.setTimeout($.proxy(function(){this.doScroll();this.didScroll=false},this),$[wps].settings.scrollThrottle)}},this)).bind("resize.waypoints",
$.proxy(function(){if(!this.didResize){this.didResize=true;window.setTimeout($.proxy(function(){$[wps]("refresh");this.didResize=false},this),$[wps].settings.resizeThrottle)}},this));$w.load($.proxy(function(){this.doScroll()},this))},getContextByElement=function(element){var found=null;$.each(contexts,function(i,c){if(c.element[0]===element){found=c;return false}});return found},methods={init:function(f,options){this.each(function(){var cElement=$.fn[wp].defaults.context,context,$this=$(this);if(options&&
options.context)cElement=options.context;if(!$.isWindow(cElement))cElement=$this.closest(cElement)[0];context=getContextByElement(cElement);if(!context){context=new Context(cElement);contexts.push(context)}var ndx=waypointIndex($this,context),base=ndx<0?$.fn[wp].defaults:context.waypoints[ndx].options,opts=$.extend({},base,options);opts.offset=opts.offset==="bottom-in-view"?function(){var cHeight=$.isWindow(cElement)?$[wps]("viewportHeight"):$(cElement).height();return cHeight-$(this).outerHeight()}:
opts.offset;if(ndx<0)context.waypoints.push({"element":$this,"offset":null,"options":opts});else context.waypoints[ndx].options=opts;if(f)$this.bind(eventName,f);if(options&&options.handler)$this.bind(eventName,options.handler)});$[wps]("refresh");return this},remove:function(){return this.each(function(i,el){var $el=$(el);$.each(contexts,function(i,c){var ndx=waypointIndex($el,c);if(ndx>=0){c.waypoints.splice(ndx,1);if(!c.waypoints.length){c.element.unbind("scroll.waypoints resize.waypoints");contexts.splice(i,
1)}}})})},destroy:function(){return this.unbind(eventName)[wp]("remove")}},jQMethods={refresh:function(){$.each(contexts,function(i,c){var isWin=$.isWindow(c.element[0]),contextOffset=isWin?0:c.element.offset().top,contextHeight=isWin?$[wps]("viewportHeight"):c.element.height(),contextScroll=isWin?0:c.element.scrollTop();$.each(c.waypoints,function(j,o){if(!o)return;var adjustment=o.options.offset,oldOffset=o.offset;if(typeof o.options.offset==="function")adjustment=o.options.offset.apply(o.element);
else if(typeof o.options.offset==="string"){var amount=parseFloat(o.options.offset);adjustment=o.options.offset.indexOf("%")?Math.ceil(contextHeight*(amount/100)):amount}o.offset=o.element.offset().top-contextOffset+contextScroll-adjustment;if(o.options.onlyOnScroll)return;if(oldOffset!==null&&c.oldScroll>oldOffset&&c.oldScroll<=o.offset)triggerWaypoint(o,["up"]);else if(oldOffset!==null&&c.oldScroll<oldOffset&&c.oldScroll>=o.offset)triggerWaypoint(o,["down"]);else if(!oldOffset&&c.element.scrollTop()>
...
arguments);else if(typeof method==="object")return methods.init.apply(this,[null,method]);else $.error("Method "+method+" does not exist on jQuery "+wp)};$.fn[wp].defaults={continuous:true,offset:0,triggerOnce:false,context:window};$[wps]=function(method){if(jQMethods[method])return jQMethods[method].apply(this);else return jQMethods["aggregate"]()};$[wps].settings={resizeThrottle:200,scrollThrottle:100};$w.load(function(){$[wps]("refresh")})})(jQuery,"waypoint","waypoints",window);jQuery.easing["jswing"]=
jQuery.easing["swing"];jQuery.extend(jQuery.easing,{def:"easeOutQuad",swing:function(x,t,b,c,d){return jQuery.easing[jQuery.easing.def](x,t,b,c,d)},easeInQuad:function(x,t,b,c,d){return c*(t/=d)*t+b},easeOutQuad:function(x,t,b,c,d){return-c*(t/=d)*(t-2)+b},easeInOutQuad:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t+b;return-c/2*(--t*(t-2)-1)+b},easeInCubic:function(x,t,b,c,d){return c*(t/=d)*t*t+b},easeOutCubic:function(x,t,b,c,d){return c*((t=t/d-1)*t*t+1)+b},easeInOutCubic:function(x,t,b,c,d){if((t/=
d/2)<1)return c/2*t*t*t+b;return c/2*((t-=2)*t*t+2)+b},easeInQuart:function(x,t,b,c,d){return c*(t/=d)*t*t*t+b},easeOutQuart:function(x,t,b,c,d){return-c*((t=t/d-1)*t*t*t-1)+b},easeInOutQuart:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t*t*t+b;return-c/2*((t-=2)*t*t*t-2)+b},easeInQuint:function(x,t,b,c,d){return c*(t/=d)*t*t*t*t+b},easeOutQuint:function(x,t,b,c,d){return c*((t=t/d-1)*t*t*t*t+1)+b},easeInOutQuint:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t*t*t*t+b;return c/2*((t-=2)*t*t*t*
t+2)+b},easeInSine:function(x,t,b,c,d){return-c*Math.cos(t/d*(Math.PI/2))+c+b},easeOutSine:function(x,t,b,c,d){return c*Math.sin(t/d*(Math.PI/2))+b},easeInOutSine:function(x,t,b,c,d){return-c/2*(Math.cos(Math.PI*t/d)-1)+b},easeInExpo:function(x,t,b,c,d){return t==0?b:c*Math.pow(2,10*(t/d-1))+b},easeOutExpo:function(x,t,b,c,d){return t==d?b+c:c*(-Math.pow(2,-10*t/d)+1)+b},easeInOutExpo:function(x,t,b,c,d){if(t==0)return b;if(t==d)return b+c;if((t/=d/2)<1)return c/2*Math.pow(2,10*(t-1))+b;return c/
2*(-Math.pow(2,-10*--t)+2)+b},easeInCirc:function(x,t,b,c,d){return-c*(Math.sqrt(1-(t/=d)*t)-1)+b},easeOutCirc:function(x,t,b,c,d){return c*Math.sqrt(1-(t=t/d-1)*t)+b},easeInOutCirc:function(x,t,b,c,d){if((t/=d/2)<1)return-c/2*(Math.sqrt(1-t*t)-1)+b;return c/2*(Math.sqrt(1-(t-=2)*t)+1)+b},easeInElastic:function(x,t,b,c,d){var s=1.70158;var p=0;var a=c;if(t==0)return b;if((t/=d)==1)return b+c;if(!p)p=d*0.3;if(a<Math.abs(c)){a=c;var s=p/4}else var s=p/(2*Math.PI)*Math.asin(c/a);return-(a*Math.pow(2,
10*(t-=1))*Math.sin((t*d-s)*2*Math.PI/p))+b},easeOutElastic:function(x,t,b,c,d){var s=1.70158;var p=0;var a=c;if(t==0)return b;if((t/=d)==1)return b+c;if(!p)p=d*0.3;if(a<Math.abs(c)){a=c;var s=p/4}else var s=p/(2*Math.PI)*Math.asin(c/a);return a*Math.pow(2,-10*t)*Math.sin((t*d-s)*2*Math.PI/p)+c+b},easeInOutElastic:function(x,t,b,c,d){var s=1.70158;var p=0;var a=c;if(t==0)return b;if((t/=d/2)==2)return b+c;if(!p)p=d*0.3*1.5;if(a<Math.abs(c)){a=c;var s=p/4}else var s=p/(2*Math.PI)*Math.asin(c/a);if(t<
1)return-0.5*a*Math.pow(2,10*(t-=1))*Math.sin((t*d-s)*2*Math.PI/p)+b;return a*Math.pow(2,-10*(t-=1))*Math.sin((t*d-s)*2*Math.PI/p)*0.5+c+b},easeInBack:function(x,t,b,c,d,s){if(s==undefined)s=1.70158;return c*(t/=d)*t*((s+1)*t-s)+b},easeOutBack:function(x,t,b,c,d,s){if(s==undefined)s=1.70158;return c*((t=t/d-1)*t*((s+1)*t+s)+1)+b},easeInOutBack:function(x,t,b,c,d,s){if(s==undefined)s=1.70158;if((t/=d/2)<1)return c/2*t*t*(((s*=1.525)+1)*t-s)+b;return c/2*((t-=2)*t*(((s*=1.525)+1)*t+s)+2)+b},easeInBounce:function(x,
t,b,c,d){return c-jQuery.easing.easeOutBounce(x,d-t,0,c,d)+b},easeOutBounce:function(x,t,b,c,d){if((t/=d)<1/2.75)return c*7.5625*t*t+b;else if(t<2/2.75)return c*(7.5625*(t-=1.5/2.75)*t+0.75)+b;else if(t<2.5/2.75)return c*(7.5625*(t-=2.25/2.75)*t+0.9375)+b;else return c*(7.5625*(t-=2.625/2.75)*t+0.984375)+b},easeInOutBounce:function(x,t,b,c,d){if(t<d/2)return jQuery.easing.easeInBounce(x,t*2,0,c,d)*0.5+b;return jQuery.easing.easeOutBounce(x,t*2-d,0,c,d)*0.5+c*0.5+b}});(function(d){function k(a){var b=
["Moz","Webkit","O","ms"],c=a.charAt(0).toUpperCase()+a.substr(1);if(a in i.style)return a;for(a=0;a<b.length;++a){var d=b[a]+c;if(d in i.style)return d}}function j(a){"string"===typeof a&&this.parse(a);return this}function p(a,b,c){!0===b?a.queue(c):b?a.queue(b,c):c()}function m(a){var b=[];d.each(a,function(a){a=d.camelCase(a);a=d.transit.propertyMap[a]||a;a=r(a);-1===d.inArray(a,b)&&b.push(a)});return b}function q(a,b,c,e){a=m(a);d.cssEase[c]&&(c=d.cssEase[c]);var h=""+n(b)+" "+c;0<parseInt(e,
10)&&(h+=" "+n(e));var f=[];d.each(a,function(a,b){f.push(b+" "+h)});return f.join(", ")}function f(a,b){b||(d.cssNumber[a]=!0);d.transit.propertyMap[a]=e.transform;d.cssHooks[a]={get:function(b){return(d(b).css("transform")||new j).get(a)},set:function(b,e){var h=d(b).css("transform")||new j;h.setFromString(a,e);d(b).css({transform:h})}}}function r(a){return a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()})}function g(a,b){return"string"===typeof a&&!a.match(/^[\-0-9\.]+$/)?a:""+a+b}function n(a){d.fx.speeds[a]&&
(a=d.fx.speeds[a]);return g(a,"ms")}d.transit={version:"0.1.3",propertyMap:{marginLeft:"margin",marginRight:"margin",marginBottom:"margin",marginTop:"margin",paddingLeft:"padding",paddingRight:"padding",paddingBottom:"padding",paddingTop:"padding"},enabled:!0,useTransitionEnd:!1};var i=document.createElement("div"),e={},s=-1<navigator.userAgent.toLowerCase().indexOf("chrome");e.transition=k("transition");e.transitionDelay=k("transitionDelay");e.transform=k("transform");e.transformOrigin=k("transformOrigin");
i.style[e.transform]="";i.style[e.transform]="rotateY(90deg)";e.transform3d=""!==i.style[e.transform];d.extend(d.support,e);var o=e.transitionEnd={MozTransition:"transitionend",OTransition:"oTransitionEnd",WebkitTransition:"webkitTransitionEnd",msTransition:"MSTransitionEnd"}[e.transition]||null,i=null;d.cssEase={_default:"ease","in":"ease-in",out:"ease-out","in-out":"ease-in-out",snap:"cubic-bezier(0,1,.5,1)"};d.cssHooks.transform={get:function(a){return d(a).data("transform")},set:function(a,b){var c=
b;c instanceof j||(c=new j(c));a.style[e.transform]="WebkitTransform"===e.transform&&!s?c.toString(!0):c.toString();d(a).data("transform",c)}};d.cssHooks.transformOrigin={get:function(a){return a.style[e.transformOrigin]},set:function(a,b){a.style[e.transformOrigin]=b}};d.cssHooks.transition={get:function(a){return a.style[e.transition]},set:function(a,b){a.style[e.transition]=b}};f("scale");f("translate");f("rotate");f("rotateX");f("rotateY");f("rotate3d");f("perspective");f("skewX");f("skewY");
f("x",!0);f("y",!0);j.prototype={setFromString:function(a,b){var c="string"===typeof b?b.split(","):b.constructor===Array?b:[b];c.unshift(a);j.prototype.set.apply(this,c)},set:function(a){var b=Array.prototype.slice.apply(arguments,[1]);this.setter[a]?this.setter[a].apply(this,b):this[a]=b.join(",")},get:function(a){return this.getter[a]?this.getter[a].apply(this):this[a]||0},setter:{rotate:function(a){this.rotate=g(a,"deg")},rotateX:function(a){this.rotateX=g(a,"deg")},rotateY:function(a){this.rotateY=
...
q})(jQuery);(function(d,D,v){d.fn.responsiveSlides=function(h){var b=d.extend({auto:!0,speed:1E3,timeout:4E3,pager:!1,nav:!1,random:!1,pause:!1,pauseControls:!1,prevText:"Previous",nextText:"Next",maxwidth:"",controls:"",namespace:"rslides",before:function(){},after:function(){}},h);return this.each(function(){v++;var e=d(this),n,p,i,k,l,m=0,f=e.children(),w=f.size(),q=parseFloat(b.speed),x=parseFloat(b.timeout),r=parseFloat(b.maxwidth),c=b.namespace,g=c+v,y=c+"_nav "+g+"_nav",s=c+"_here",j=g+"_on",
z=g+"_s",o=d("<ul class='"+c+"_tabs "+g+"_tabs' />"),A={"float":"left",position:"relative"},E={"float":"none",position:"absolute"},t=function(a){b.before();f.stop().fadeOut(q,function(){d(this).removeClass(j).css(E)}).eq(a).fadeIn(q,function(){d(this).addClass(j).css(A);b.after();m=a})};b.random&&(f.sort(function(){return Math.round(Math.random())-0.5}),e.empty().append(f));f.each(function(a){this.id=z+a});e.addClass(c+" "+g);h&&h.maxwidth&&e.css("max-width",r);f.hide().eq(0).addClass(j).css(A).show();
if(1<f.size()){if(x<q+100)return;if(b.pager){var u=[];f.each(function(a){a=a+1;u=u+("<li><a href='#' class='"+z+a+"'>"+a+"</a></li>")});o.append(u);l=o.find("a");h.controls?d(b.controls).append(o):e.after(o);n=function(a){l.closest("li").removeClass(s).eq(a).addClass(s)}}b.auto&&(p=function(){k=setInterval(function(){f.stop(true,true);var a=m+1<w?m+1:0;b.pager&&n(a);t(a)},x)},p());i=function(){if(b.auto){clearInterval(k);p()}};b.pause&&e.hover(function(){clearInterval(k)},function(){i()});b.pager&&
(l.bind("click",function(a){a.preventDefault();b.pauseControls||i();a=l.index(this);if(!(m===a||d("."+j+":animated").length)){n(a);t(a)}}).eq(0).closest("li").addClass(s),b.pauseControls&&l.hover(function(){clearInterval(k)},function(){i()}));if(b.nav){c="<a href='#' class='"+y+" prev'>"+b.prevText+"</a><a href='#' class='"+y+" next'>"+b.nextText+"</a>";h.controls?d(b.controls).append(c):e.after(c);var c=d("."+g+"_nav"),B=d("."+g+"_nav.prev");c.bind("click",function(a){a.preventDefault();if(!d("."+
j+":animated").length){var c=f.index(d("."+j)),a=c-1,c=c+1<w?m+1:0;t(d(this)[0]===B[0]?a:c);b.pager&&n(d(this)[0]===B[0]?a:c);b.pauseControls||i()}});b.pauseControls&&c.hover(function(){clearInterval(k)},function(){i()})}}if("undefined"===typeof document.body.style.maxWidth&&h.maxwidth){var C=function(){e.css("width","100%");e.width()>r&&e.css("width",r)};C();d(D).bind("resize",function(){C()})}})}})(jQuery,this,0);window.selectnav=function(){return function(p,q){var a,h=function(b){var c;b||(b=window.event);
b.target?c=b.target:b.srcElement&&(c=b.srcElement);3===c.nodeType&&(c=c.parentNode);c.value&&(window.location.href=c.value)},k=function(b){b=b.nodeName.toLowerCase();return"ul"===b||"ol"===b},l=function(b){for(var c=1;document.getElementById("selectnav"+c);c++);return b?"selectnav"+c:"selectnav"+(c-1)},n=function(b){g++;var c=b.children.length,a="",d="",f=g-1;if(c){if(f){for(;f--;)d+=r;d+=" "}for(f=0;f<c;f++){var e=b.children[f].children[0];if("undefined"!==typeof e){var h=e.innerText||e.textContent,
i="";j&&(i=-1!==e.className.search(j)||-1!==e.parentElement.className.search(j)?m:"");s&&!i&&(i=e.href===document.URL?m:"");a+='<option value="'+e.href+'" '+i+">"+d+h+"</option>";t&&(e=b.children[f].children[1])&&k(e)&&(a+=n(e))}}1===g&&o&&(a='<option value="">'+o+"</option>"+a);1===g&&(a='<select class="selectnav" id="'+l(!0)+'">'+a+"</select>");g--;return a}};if((a=document.getElementById(p))&&k(a)){document.documentElement.className+=" js";var d=q||{},j=d.activeclass||"active",s="boolean"===typeof d.autoselect?
d.autoselect:!0,t="boolean"===typeof d.nested?d.nested:!0,r=d.indent||"\u2192",o=d.label||"- Navigation -",g=0,m=" selected ";a.insertAdjacentHTML("afterend",n(a));a=document.getElementById(l());a.addEventListener&&a.addEventListener("change",h);a.attachEvent&&a.attachEvent("onchange",h)}}}()})(window.jQuery);window.log=function(){log.history=log.history||[];log.history.push(arguments);if(this.console)console.log(Array.prototype.slice.call(arguments))};
